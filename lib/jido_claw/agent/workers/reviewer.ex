defmodule JidoClaw.Agent.Workers.Reviewer do
  ...
  use JidoClaw.Agent.Defaults,
    ...
    description:
      "Reviews code changes for bugs, style issues, and correctness. Read-only access with git diff capabilities. Return a structured review (`overall`, short `summary`, an `action_needed` line, and a list of `findings`, each with a short stable `title`, `severity` info/warning/error, `confidence` likely/unsure, `location`, and `description`).",
    tools: [
