  ...
  def render(assigns) do
    ...
    <div style="display: flex; justify-content: center; align-items: center; min-height: 80vh;">
      <div class="card" style="width: 400px;">
        <h1 style="font-size: 1.25rem; font-weight: 700; margin-bottom: 1.5rem; text-align: center;">
          Sign in to JidoClaw
        </h1>
        ...
        >
          ...
          <div>
            <label style="display: block; color: var(--muted); font-size: 0.875rem; margin-bottom: 0.25rem;">
              Email
            </label>
