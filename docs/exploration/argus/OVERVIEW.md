...
Things we explicitly deferred during the exploration. Status per item — [FLOW](FLOW.md) has since settled two of the four (items 2 and 4); items 1 and 3 still hold a real decision to make before building.
