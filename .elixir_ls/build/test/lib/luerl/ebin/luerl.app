{application,luerl,
             [{description,"Luerl - an implementation of Lua on Erlang"},
              {vsn,"1.5.1"},
              {modules,['Elixir.Luerl.Old','Elixir.Luerl',luerl,luerl_anno,
                        ...
                        luerl_io,luerl_lib,luerl_lib_basic,luerl_lib_bit32,
                        ...
                        luerl_lib_table,luerl_lib_utf8,luerl_old,luerl_parse,
